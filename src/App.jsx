...
/* ────────────────────────────────────────
   PROMO POPUP — Día del Niño 2026
   ──────────────────────────────────────── */
const PROMO_END = new Date("2026-08-15T23:59:59");
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{ backgroundColor: "#E5007A", maxHeight: "94vh", overflowY: "auto" }}
      >
        <button
        ...
        <div className="px-7 pt-8 pb-5 text-center">
          ...
          <h2 className="text-2xl font-extrabold text-white leading-tight mb-3">
            Regálale algo<br />que no se rompa
          </h2>
          ...
          <p className="text-xs mt-4 leading-relaxed" style={{ color: "rgba(255,255,255,0.85)" }}>
            En una sesión le retiramos la placa y el sarro, pulimos cada diente
            y aplicamos flúor para reforzar el esmalte. Sin dolor y sin apuro.
          </p>
        </div>
        ...
        <p className="text-xs font-semibold text-center mt-4 px-6" style={{ color: "rgba(255,255,255,0.92)" }}>
          Pacientes nuevos y antiguos &middot; Hasta el 15 de agosto
        </p>
