...
export default function Floating({ children, className = "", sensitivity = 1, easingFactor = 0.05, ...props }) {
  ...
  return (
    <FloatingContext.Provider value={{ registerElement, unregisterElement }}>
      <div ref={containerRef} className={`absolute top-0 left-0 w-full h-full ${className}`} {...props}>
        {children}
      </div>
